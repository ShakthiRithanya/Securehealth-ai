...
def fmt(lg: AccessLog):
    return {
        ...
        "user_role": lg.user.role if lg.user else "unknown",
        "patient_id": lg.patient_id,
        "patient_name": lg.patient.name if lg.patient else None,
        "action": lg.action,
...
async def write_log(
    ...
    if mgr:
        await mgr.broadcast({
            ...
            "patient_id": lg.patient_id,
            "patient_name": lg.patient.name if lg.patient else None,
            "patient_ward": lg.patient.ward if lg.patient else None,
            "action": lg.action,
            "resource": lg.resource,
